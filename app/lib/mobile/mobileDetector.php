		...
		private function detect()
		{
			switch (true)
			{
				case (preg_match('/ipad/i', $this->_ua));
					$this->_mobile = true;
					$this->_smartphone = true;
					$this->_status = 'Apple iPad';
					break;

				case (preg_match('/iphone/i', $this->_ua) || preg_match('/ipod/i', $this->_ua));
					$this->_mobile = true;
					$this->_smartphone = true;
					$this->_status = 'Apple';
					break;

				case (preg_match('/android/i', $this->_ua));
					$this->_mobile = true;
					$this->_smartphone = true;
					$this->_status = 'Android';
					break;

				case (preg_match('/opera mini/i', $this->_ua));
					$this->_mobile = true;
					$this->_status = 'Opera';
					break;
				...
				case (preg_match('/(iris|3g_t|windows ce|opera mobi|windows ce; smartphone;|windows ce; iemobile)/i', $this->_ua));
					$this->_mobile = true;
					$this->_smartphone = false;
					$this->_status = 'Windows Smartphone';
					break;
