<?php
    ...
    include_once $_DIR_ . '/../lib/rightsMan.php';
    include_once $_DIR_ . '/../lib/userMan.php';
    include_once $_DIR_ . '/../lib/dbMan.php';
    ...
    // Locale definition for time expressions (strftime())
    setlocale(LC_TIME, 'fr_FR.UTF8', 'fra'); // Defaults to French, sorry, rest of the world, you'll have to change it.

    // Website constants
    define('SITE_PATH', $sitePath); // Real path to website root
    define('SITE_NAME', 'TakPHPLib'); // Displayed site name
    define('SITE_DESCRIPTION', "Description du site"); // Website description used by search engines
    define('SITE_KEYWORDS', 'test,takphplib,otak,framework'); // Website keywords
    ...
    define('BASE_URL', 'http'.(IS_HTTPS ? 's' : '').'://'.$_SERVER['SERVER_NAME'].':'.SITE_PORT.SITE_PATH); // AutoGenerated to make links to website home
